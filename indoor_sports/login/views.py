...
#             set_session(request, user.userid, "user")
#             user.lastlogin = now()
...
#             set_session(request, admin.adminid, "admin")
#             admin.lastlogin = now()
#             admin.save(update_fields=["lastlogin"])
#             logger.info("Admin %s logged in successfully.", admin.emailid)
#             messages.success(request, "Login successful! Redirecting to Admin Dashboard.")
#             return redirect("admin_dashboard")

#         logger.error("Invalid credentials for identifier %s", identifier)
...
#     """
#     Logs out the user/admin and clears session data.
#     """
