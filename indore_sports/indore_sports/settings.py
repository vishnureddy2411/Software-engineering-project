"""
Django settings for indore_sports project.
...
SECRET_KEY = 'django-insecure-xbv3id9&)xi1@90@973@c6qf#1^9*-0o-!bd$b*8cs5us*4dgo'
...
INSTALLED_APPS = [
    ...
    # Add your apps here
    'accounts',  # App for user account management
...
ROOT_URLCONF = 'indore_sports.urls'
